...
/**
 * Client catalog UI for the Agent Exchange. The server page decides which
 * agents this viewer may see (audience share links) and passes them in.
 */
export function ExchangeCatalog({ agents }: { agents: ExchangeAgent[] }) {
