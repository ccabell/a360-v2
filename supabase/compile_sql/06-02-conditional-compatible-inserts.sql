-- Phase 06 Plan 04 / Phase 10 Reconciled: Conditional + Compatible_only tier INSERT statements
...
'Expert consensus:multi-modality stacking protocol. Condition: provider discretion on same-day sequencing.'
...
'Expert consensus:multi-modality stacking. Condition: allow SMAS inflammation to resolve before neurotoxin.'
...
'Expert consensus:multi-modality approach. Condition: less direct synergy, provider-driven sequencing.'
...
'Expert consensus:category-level neurotoxin+energy evidence'
...
'Expert consensus:category-level evidence'
...
'Energy first, neurotoxin after.', true, true, false, 'Expert consensus:category-level evidence'
...
'Expert consensus:filler+energy stacking, skin quality should be addressed before volumizing'
...
'Expert consensus:energy+filler stacking'
...
'Energy first, filler after.', true, true, false, 'Expert consensus:energy+filler stacking'
...
'Energy first, SKINVIVE after.', true, true, false, 'Expert consensus:energy+filler stacking'
...
'Energy first, SKINVIVE after.', true, true, false, 'Expert consensus:energy+skin quality stacking'
...
'Laser pigment correction first, filler after skin heals.', true, true, false, 'Expert consensus:energy+filler category evidence'
...
'Laser first, filler after.', true, true, false, 'Expert consensus:energy+filler category evidence'
...
'Expert consensus:biostimulator+energy evidence'
...
'Expert consensus:Sculptra+Ultherapy expert discussion'
...
'Expert consensus:biostimulator+energy category evidence'
...
'Expert consensus:HydraFacial 45% conversion data, skincare foundation approach'
...
'Multi-energy stacking protocol. Cumulative tissue trauma must be assessed. Provider discretion.', true, true, false,
'Expert consensus: temperature layering protocol'
...
'Expert consensus:temperature layering'
...
'Expert consensus:skincare foundation approach'
...
'Expert consensus:Ozempic face discussion, Ultherapy chin/neck evidence'
...
'Expert consensus:submental treatment discussion. LOW_CONFIDENCE.'
...
'Expert consensus:Dr. Tom van Eijk fern pattern protocol, depth-layering evidence'
...
'Expert consensus:depth-layering evidence'
