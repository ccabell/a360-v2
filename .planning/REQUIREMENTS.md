...
- [x] **SRC-02**: "Reliable" green badge on Tier 1 (FDA/manufacturer label) and Tier 2 (peer-reviewed/academic) sources in reference list (REQ-REF-04, REQ-TIER-01)
- [x] **SRC-03**: Category pills on each reference: "Journal", "Multi-Specialty", "Regulatory", "Government medical Authority", "Clinical Education", "Manufacturer", etc. (REQ-REF-03)
